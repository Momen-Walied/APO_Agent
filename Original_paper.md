...
Qizheng Zhang<sup>1\*</sup> Changran Hu<sup>2\*</sup> Shubhangi Upasani<sup>2</sup> Boyuan Ma<sup>2</sup> Fenglu Hong<sup>2</sup>  
Vamsidhar Kamanuru<sup>2</sup> Jay Rainton<sup>2</sup> Chen Wu<sup>2</sup> Mengmeng Ji<sup>2</sup> Hanchen Li<sup>3</sup>  
Urmish Thakker<sup>2</sup> James Zou<sup>1</sup> Kunle Olukotun<sup>1</sup>

<sup>1</sup> Stanford University <sup>2</sup> SambaNova Systems, Inc. <sup>3</sup> UC Berkeley \*equal contribution
...
![Figure 1: Three bar charts showing Overall Performance Results. The charts compare the proposed framework, ACE, against strong baselines (Base LLM, ICL, GEPA, DC) across three tasks: Agent: AppWorld, Domain Knowledge: FiNER, and Numerical Reasoning: Formula. ACE consistently achieves the highest accuracy across all tasks.]()![](_page_0_Figure_8.jpeg)
...
![Figure 2: Context Collapse. A line graph showing the number of tokens in context (Y-axis, 0 to 20,000) versus the number of adaptation steps (X-axis, 0 to 80). The context size generally increases, but there is a sharp drop at step 60. Annotations indicate: At step 0, Accuracy w/o context: 63.7. At step 50, # Tokens: 122, Accuracy: 57.1. At step 60, # Tokens: 18,282, Accuracy: 66.7.]()![](_page_2_Figure_6.jpeg)
...
![Figure 4: The ACE Framework. The diagram shows an agentic architecture with three specialized components: a Generator, a Reflector, and a Curator, all utilizing LLMs. The workflow starts with a Query and Context Playbook feeding into the LLM Generator, which outputs a Trajectory. The Trajectory feeds into the LLM Reflector. The Reflector performs Iterative Refinement and outputs Insights. The Insights feed into the LLM Curator. The Curator outputs Delta Context Items, which are used to Update the Context Playbook, completing the cycle.]()![](_page_4_Figure_0.jpeg)
...
| ReAct + ACE               | X         | 75.0 <sup>+11.3</sup> | 64.3 <sup>+21.4</sup> | 54.4 <sup>+12.9</sup> | 35.2 <sup>+13.6</sup> | 57.2 <sup>+14.8</sup> |
| Online Adaptation         |           |                       |                       |                       |                       |                       |
| ReAct + DC (CU)           | X         | 65.5 <sup>+1.8</sup>  | 58.9 <sup>+16.0</sup> | 52.3 <sup>+10.8</sup> | 30.8 <sup>+9.2</sup>  | 51.9 <sup>+9.5</sup>  |
| ReAct + ACE               | X         | 69.6 <sup>+5.9</sup>  | 53.6 <sup>+10.7</sup> | 66.0 <sup>+24.5</sup> | 48.9 <sup>+27.3</sup> | 59.5 <sup>+17.1</sup> |
...
| ACE                       | X         | 71.1 <sup>+0.4</sup> | 83.0 <sup>+15.5</sup> | 77.1 <sup>+8.0</sup>  |
| Online Adaptation         |           |                      |                       |                       |
| DC (CU)                   | ✓         | 74.2 <sup>+3.5</sup> | 69.5 <sup>+2.0</sup>  | 71.8 <sup>+2.7</sup>  |
| DC (CU)                   | X         | 68.3 <sup>-2.4</sup> | 62.5 <sup>-5.0</sup>  | 65.4 <sup>-3.7</sup>  |
| ACE                       | ✓         | 76.7 <sup>+6.0</sup> | 76.5 <sup>+9.0</sup>  | 76.6 <sup>+7.5</sup>  |
| ACE                       | X         | 67.3 <sup>-3.4</sup> | 78.5 <sup>+11.0</sup> | 72.9 <sup>+3.8</sup>  |
...
| ReAct + ACE                              | ✓         | 76.2 <sup>+12.5</sup> | 64.3 <sup>+21.4</sup> | 57.3 <sup>+15.8</sup> | 39.6 <sup>+18.0</sup> | 59.4 <sup>+17.0</sup> |
| Online Adaptation                        |           |                       |                       |                       |                       |                       |
| ReAct + ACE                              | X         | 67.9 <sup>+4.2</sup>  | 51.8 <sup>+8.9</sup>  | 61.4 <sup>+19.9</sup> | 43.2 <sup>+21.6</sup> | 56.1 <sup>+13.7</sup> |
| ReAct + ACE + offline warmup             | X         | 69.6 <sup>+5.9</sup>  | 53.6 <sup>+10.7</sup> | 66.0 <sup>+24.5</sup> | 48.9 <sup>+27.3</sup> | 59.5 <sup>+17.1</sup> |
...
[11] Tianxiang Chen, Zhen Tao Tan, Xiaofan Bo, Yue Wu, Tao Gong, Qi Chu, Jieping Ye, and Nenghai Yu. Flora: Effortless context construction to arbitrary length and scale. *arXiv preprint arXiv:2507.19786*, 2025.
...
[33] Lefteris Loukas, Manos Fergadiotis, Ilias Chalkidis, Eirini Spyropoulou, Prodromos Malakasiotis, Ion Androuloupoulos, and Georgios Palouras. Finer: Financial numeric entity recognition for xbrl tagging. *arXiv preprint arXiv:2203.06482*, 2022.
...
[51] Jiayi Yao, Hanchen Li, Yuhuan Liu, Siddhant Ray, Yihua Cheng, Qizheng Zhang, Kuntai Du, Shan Lu, and Junchen Jiang. Cacheblend: Fast large language model serving for rag with cached knowledge fusion. In *Proceedings of the Twentieth European Conference on Computer Systems*, pages 94–109, 2025.
...
| Agent Scores                                                                              |                     | Raw Data                    |            | Interactions                            |      |                |      |
|-------------------------------------------------------------------------------------------|---------------------|-----------------------------|------------|-----------------------------------------|------|----------------|------|
| Add your agent to the leaderboard <a href="#">following the instructions</a> on GitHub. 🌟 |                     | All Level 1 Level 2 Level 3 |            | Plot Scores Plot Scores vs Interactions |      |                |      |
...
2. Remember that the email addresses, access tokens and variables (e.g. spotify\_password) in the example above are not valid anymore.
...
```
# To get a list of apps that are available to you.
print(api_docs.show_app_descriptions())

# To get the list of apis under any app listed above, e.g. spotify
print(api_docs.show_api_descriptions(app_name='spotify'))

# To get the specification of a particular api, e.g. spotify app's login api
print(api_docs.show_api_doc(app_name='spotify', api_name='login'))
```
